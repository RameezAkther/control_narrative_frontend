    ...
    if (error) {
      return (
        <div className="h-96 flex flex-col items-center justify-center text-gray-400 bg-gray-50 rounded-xl border border-dashed border-gray-300">
          ...
          <p className="text-sm mt-2">The pipeline might still be processing this stage.</p>
        </div>
      );
    }
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="flex justify-between items-center px-4 py-2 bg-gray-50 border-b border-gray-200">
          <span className="text-xs text-gray-500 font-mono uppercase">{activeTab} View</span>
          <button onClick={handleCopy} className="text-gray-500 hover:text-gray-900 transition">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            <Link to="/documents" className="p-2 hover:bg-gray-100 rounded-full text-gray-500 transition-colors">
              <ArrowLeft size={20} />
            </Link>
            <div>
              <h1 className="text-xl font-bold text-gray-900 truncate max-w-md" title={docMeta.filename}>
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-2 px-3 py-1.5 text-sm text-gray-600 hover:bg-gray-100 rounded-md border border-gray-200 transition">
